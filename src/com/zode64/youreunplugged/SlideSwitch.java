...
/**
 * A SlideSwitch is a two-state toggle switch widget that can select between two
...
public class SlideSwitch extends CompoundButton {
	...
	/**
	 * Construct a new SlideSwitch with default styling.
	 * 
	 * @param context
	...
	/**
	 * Construct a new SlideSwitch with default styling, overriding specific style
	...
	/**
	 * Construct a new SlideSwitch with a default style determined by the given
	...
	public SlideSwitch(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.SlideSwitch, defStyle, 0);

		mLeftBackground = a.getDrawable(R.styleable.SlideSwitch_leftBackground);
		// if (mLeftBackground == null) {
		// mLeftBackground = new ColorDrawable(0xFF11BB33);
		// }
		mRightBackground = a.getDrawable(R.styleable.SlideSwitch_rightBackground);
		// if (mRightBackground == null) {
		// mRightBackground = new ColorDrawable(0x993322BB);
		// }

		mOrientation = a.getInteger(R.styleable.SlideSwitch_orientation,
				HORIZONTAL);
		// Log.d(TAG, "mLeftBackground="+mLeftBackground);
		// Log.d(TAG, "mRightBackground="+mRightBackground);
		mThumbDrawable = a.getDrawable(R.styleable.SlideSwitch_thumb);
		mTrackDrawable = a.getDrawable(R.styleable.SlideSwitch_track);
		mTextOn = a.getText(R.styleable.SlideSwitch_textOn);
		mTextOff = a.getText(R.styleable.SlideSwitch_textOff);
		mDrawableOn = a.getDrawable(R.styleable.SlideSwitch_drawableOn);
		mDrawableOff = a.getDrawable(R.styleable.SlideSwitch_drawableOff);
		mPushStyle = a.getBoolean(R.styleable.SlideSwitch_pushStyle, false);
		mTextOnThumb = a.getBoolean(R.styleable.SlideSwitch_textOnThumb, false);
		mThumbExtraMovement = a.getDimensionPixelSize(
				R.styleable.SlideSwitch_thumbExtraMovement, 0);
		mThumbTextPadding = a.getDimensionPixelSize(
				R.styleable.SlideSwitch_thumbTextPadding, 0);
		mTrackTextPadding = a.getDimensionPixelSize(
				R.styleable.SlideSwitch_trackTextPadding, 0);
		mSwitchMinWidth = a.getDimensionPixelSize(
				R.styleable.SlideSwitch_switchMinWidth, 0);
		mSwitchMinHeight = a.getDimensionPixelSize(
				R.styleable.SlideSwitch_switchMinHeight, 0);
		mSwitchPadding = a.getDimensionPixelSize(
				R.styleable.SlideSwitch_switchPadding, 0);
		...
		mMaskDrawable = a.getDrawable(R.styleable.SlideSwitch_backgroundMask);
		...
		int appearance = a.getResourceId(
				R.styleable.SlideSwitch_switchTextAppearanceAttrib, 0);
		if (appearance != 0) {
	...
	private Layout makeLayout(CharSequence text) {
		StaticLayout sl = new StaticLayout(text, mTextPaint,
